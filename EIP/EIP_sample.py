...
def geterrInfo(page):
    ...
    url = "http://eip.megmeet.com:8008/km/review/km_review_index/kmReviewIndex.do?method=list&q.j_path=%2FlistAll&q.mydoc=all&q.fdTemplate=16536f1f7ac30fec148fcb048bcb5cf5&q.s_raq=0.032122557289194775&pageno={}&rowsize=30&orderby=docCreateTime&ordertype=down&s_ajax=true".format(page)
    # data={
    #     'method': 'list',
    #     'q.mydoc': 'all',
    #     'q.j_path': '/listAll',
    ...
    with open('data.csv', 'a', encoding='utf-8') as file:
        ...
        for i in  result['datas']:
            ...
            html = rsp.read().decode()
            info=etree.HTML(html).xpath("//div[@class='select_div_box xform_Select']/xformflag/text()")
            print(info)
            info.append(fdnumber)
