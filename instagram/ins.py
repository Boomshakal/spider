...
headers = {
    ...
    'cookie': 'mid=XL1TOAAEAAHPVETtpYGXgm5LCuM3; csrftoken=yKGcC5k0ZQX50RMzdBXkhN7AGGse7IOM; ds_user_id=12609017558; sessionid=12609017558%3AQFgZsgsw9J5RwJ%3A8; rur=ATN; urlgen="{\"35.241.85.49\": 15169}:1hIXIv:SQVrwTqhrUEHf6ra_hWyf_JNLj0"'
}
...
def main(user):
    url = url_base + user + '/'
    html = get_html(url)
    dirpath = r'Instagram\{0}'.format(user)
    ...
    for urls in get_urls(html):
        try:
            ...
            for i, content in enumerate(contents):
                file_path = r'Instagram\{0}\{1}.{2}'.format(user, md5(content).hexdigest(), urls[i][-43:-40])
